...
<html>
	<head>
		...
		<title>Novo time | Suricato Agil</title>
	</head>
	<body>
		<%@include file="/WEB-INF/views/header.jsp" %>
		<div class="corpo">
			<h2 class="corpo-descricao"><fmt:message key="team.new.title"/></h2>
			<form action="<c:url value='/time/criar'/>" class="cadastro" method="post">
				...
				<button type="submit" class="cadastro-botao"><fmt:message key="team.new.button"/></button>
			</form>
		</div>
